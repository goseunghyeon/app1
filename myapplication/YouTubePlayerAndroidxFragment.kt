...
class YouTubePlayerAndroidxFragment : Fragment(), Provider {
    ...
    private var onInitializedListener: YouTubePlayerView.OnInitializedListener? = null

    override fun initialize(developerKey: String, onInitializedListener: YouTubePlayerView.OnInitializedListener?) {
